...
32076d3 Mine real cross-camera journeys from the grid's looping recordings

 netra/analytics/loop_index.py | 670 ++++++++++++++++++++++++++++++++++++++++++
 netra/api/app.py              |  49 +++
 netra/core/models.py          |  31 ++
 tools/index_loops.py          | 124 ++++++++
 4 files changed, 874 insertions(+)

diff --git a/netra/analytics/loop_index.py b/netra/analytics/loop_index.py
new file mode 100644
index 0000000..21c45b3
--- /dev/null
...
index d08d937..0779f44 100644
--- a/netra/api/app.py
+++ b/netra/api/app.py
@@ -895,20 +895,69 @@ def cloned_plates(min_confidence: float = Query(0.6, ge=0.0, le=0.99),
     return {
...
index 9c8c75b..79081f4 100644
--- a/netra/core/models.py
+++ b/netra/core/models.py
@@ -209,10 +209,41 @@ class TrafficStat(Base):
